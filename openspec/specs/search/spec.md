...
Provide a unified search capability shared by all three applications (Analytics, Investigator, Case Manager), routing queries to the appropriate strategy based on JWT claims and enforcing authorization via the flattened permission set.
